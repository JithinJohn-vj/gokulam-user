...
export const dineInData = async (data : any) => {
  console.log(data)
  try {
    const response = await axiosAdmin.post(B_DineInDetails, data);
...
export const checkoutData = async (data : any) => {
  console.log(data)
  try {
    const response = await axiosAdmin.post(B_checkout, data);
    console.log(response);
    // UserCredentials.setState({ user: response.data });
    return response.data;
  } catch (error) {
